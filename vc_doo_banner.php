 ...
 extract( shortcode_atts( array(
    ...
    $end_content = '<a class="service websites" style="background-color:'.$background.';  height:'.$height.'px;" href="'.$href['url'].'" title="'.$href['title'].'">
                                <span class="static">
                                    <span class="vcenter-parent">
                                        <span class="vcenter">
                                            ...
                                            <span class="title" style="color:'.$title_font_color.';">'.$header.'</span>
                                        </span><!-- .vcenter -->
                                    </span><!-- .vcenter-parent -->
                                </span><!-- /.static -->
                                <span class="hover" style="background-color:'.$background_overlay.'">
                                    <span class="vcenter-parent">
                                        <span class="vcenter">
                                            <h3 class="title" style="color:'.$title_overlay_font_color.'">'.$header.'</h3>
                                            <p class="description" style="color:'.$description_font_color.'">'.$content.'</p>
                                        </span><!-- .vcenter -->
                                    </span><!-- .vcenter-parent -->
                                </span><!-- /.hover -->
                            </a>';
